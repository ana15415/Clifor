		...
		<table class="table table-striped table-hover">
			...
			<tbody>
				<?php
					 ...
					 echo "<td id='mascota:$user' class='cam_editable' contenteditable='true'>".$usuarios['mascota']."</td>";
					 //////////////////////////////////////
                         echo "<td id='sexo:$user' class='cam_editable' contenteditable='true'>".$usuarios['sexo']."</td>";
					 echo "<td id='edad:$user' class='cam_editable' contenteditable='true'>".$usuarios['edad']."</td>";
					 echo "<td id='raza:$user' class='cam_editable' contenteditable='true'>".$usuarios['raza']."</td>";
					 echo "<td id='servicio:$user' class='cam_editable' contenteditable='true'>".$usuarios['servicio']."</td>";
